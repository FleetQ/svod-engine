...
tasks.test {
    ...
    for (p in listOf("svod.perf", "svod.notes", "svod.writers", "svod.eval.vault", "svod.eval.golden", "svod.eval.sweep", "svod.eval.indexDir", "svod.eval.embedders", "svod.eval.embedder", "svod.eval.reranker", "svod.eval.diag"))
